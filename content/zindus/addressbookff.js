...
AddressBookFf.prototype.getCardProperties = function (abCard) {
    return this.getCardElements(abCard, 'properties');
}
AddressBookFf.prototype.getCardAttributes = function (abCard) {
    return this.getCardElements(abCard, 'attributes');
}
...
AddressBookFf.prototype.getCardProperty = function (abCard, key) {
    ...
    //
    zinAssertAndLog(key in properties, function () {
        return "properties: " + aToString(properties) + " key: " + key;
    });
