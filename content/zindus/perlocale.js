...
var PerLocaleStatic = {
    ...
    load_properties:       function () {
        ...
        l.push("tb.pab");
        r.push(TB_PAB_FULLNAME);
        l.push("zm.emailedcontacts");
        r.push(ZM_FOLDER_EMAILED_CONTACTS);
        l.push("gd.contacts");
        r.push(ContactGoogle.eSystemGroup.Contacts);
        l.push("gd.coworkers");
        r.push(ContactGoogle.eSystemGroup.Coworkers);
        l.push("gd.family");
        r.push(ContactGoogle.eSystemGroup.Family);
        l.push("gd.friends");
        r.push(ContactGoogle.eSystemGroup.Friends);
        l.push("gd.suggested");
        r.push(ContactGoogle.eSystemGroup.Suggested);
        ...
        while (enm.hasMoreElements()) {
            ...
            zinAssertAndLog(a.length == 4, elem.key);
            let locale = a[1];
            let key = a[2];
            let oldver = a[3];
