...
var AppInfo = {
    ...
    app_name:            function (arg) {
        if (!this.m_m_app_name) {
            ...
            switch (appInfo.ID) {
                case FF_ID:
                    this.m_app_name = this.eApp.firefox;
                    break;
                case TB_ID:
                    this.m_app_name = this.eApp.thunderbird;
                    break;
                case SM_ID:
                    this.m_app_name = this.eApp.seamonkey;
                    break;
                case PE_ID:
                case PB_ID:
                    this.m_app_name = this.eApp.postbox;
                    break;
                case SB_ID:
                    this.m_app_name = this.eApp.spicebird;
                    break;
                default:
                    this.m_app_name = this.eApp.other;
                    break;
            }
        }
